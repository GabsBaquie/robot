...
export default function Home() {
  ...
  // Call this function when your canvas is loaded
  ...
  return (
    <>
      {showScroll && (
        ...
        absolute
        pt-10
        inset-0 z-20 text-center 
        text-3xl
        text-primary
        h-20
        ">
          <p>Scroll down</p>
          <span className="text-2xl size-5">▼</span>
        </div>
      )}
      <Canvas shadows onCreated={() => setCanvasLoaded(true)}>
          ...
          <Scroll html style={{ width: "100%" }}>
            ...
            <div className="absolute top-[100vh] left-14 ">
              ...
              <p className="max-w-[400px] text-xl my-4">
                ...
                avancées technologiques, ce petit robot est à la fois charmant
                et fonctionnel. Mais il ne se contente pas d&apos;être mignon :
                à l&apos;intérieur, il est équipé d&aspo;une intelligence
            ...
            <div className="absolute top-[180vh] right-14">
              <div className=" ">
                ...
                <p className="max-w-[440px] text-xl my-4">
                  ...
                  parfaitement adapté pour naviguer dans les espaces restreints
                  et effectuer une variété de tâches, que ce soit à la maison,
                  au bureau ou en déplacement. Que ce soit pour vous aider dans
                  vos tâches ménagères, vous tenir compagnie ou vous assister
                  dans vos activités quotidiennes, ce robot polyvalent est prêt
                  à devenir votre fidèle compagnon technologique.
                </p>
                <Button>Read more</Button>
              </div>
            </div>
